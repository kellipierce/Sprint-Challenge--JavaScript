...
array with only the animal_name and scientific_name of each animal. displayNames will be an array of strings, and each string 
...
const annyMap = zooAnimals.map((name) =>
